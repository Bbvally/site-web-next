...
import { iconMap, ArrowRight, MapPin, Quote } from "@/components/icons";
    ...
    <main className="min-h-screen bg-bg">
      ...
      <section className="bg-white py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-4 text-text-secondary">
            View our transparent pricing and flexible packages for {industry.name.toLowerCase()} businesses.
          </p>
          <div className="mt-8">
            <Link
              href="/pricing/"
