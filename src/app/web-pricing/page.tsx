...
export const metadata: Metadata = {
  title: "🌐 Web Development Pricing — Professional Websites from ₦150,000 | BuyReviewsInNigeria",
  description:
    "Get a professional website or web application. Landing pages from ₦150,000, E-commerce from ₦920,000. Includes 1 year hosting & support. ✅ Free quote.",
  alternates: { canonical: "https://buyreviewsinnigeria.com/web-pricing/" },
};

export default function WebPricingPage() {
  const breadcrumbs = buildBreadcrumbs([
    { label: "Web Development Pricing", href: "/web-pricing/" },
  ]);
  ...
  const jsonLd = {
    ...
    description:
      "Professional website and web application development services in Nigeria",
    offers: webdevPlans.map((plan) => ({
      "@type": "Offer",
      name: plan.name,
        ...
        <section className="relative overflow-hidden bg-white py-20">
          ...
          <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6">
            <h1 className="font-heading text-4xl font-bold text-text-primary sm:text-5xl">
              Web <span className="gradient-text-blue">Development</span> Pricing
            </h1>
            <p className="mt-6 text-lg text-text-secondary">
              Professional websites and web applications. All packages include 1 year of hosting, security updates, and support.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-4xl px-4 sm:px-6">
            ...
            <p className="mt-4 text-center text-text-secondary">
              Complement your website with these add-on services.
            </p>
            <div className="mt-12 space-y-4">
              {webdevAddOns.map((service, index) => {
                const color = getColorForIndex(index);
                return (
                  <div
                    key={service.name}
